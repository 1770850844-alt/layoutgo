...
- [下载 macOS（Apple Silicon / M 系列）`.dmg`](https://github.com/1770850844-alt/layoutgo/releases/download/app-v0.1.7/LayoutGo_0.1.7_aarch64.dmg)
- [下载 Windows 64 位 `.exe`](https://github.com/1770850844-alt/layoutgo/releases/download/app-v0.1.7/LayoutGo_0.1.7_x64-setup.exe)
