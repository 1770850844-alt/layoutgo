...
- [下载 macOS（Apple Silicon / M 系列）版 LayoutGo 0.1.4 `.dmg`](https://github.com/1770850844-alt/layoutgo/releases/download/app-v0.1.4/LayoutGo_0.1.4_aarch64.dmg)
- [下载 Windows 64 位版 LayoutGo 0.1.4 `.exe`](https://github.com/1770850844-alt/layoutgo/releases/download/app-v0.1.4/LayoutGo_0.1.4_x64-setup.exe)
