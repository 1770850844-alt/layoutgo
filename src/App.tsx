...
const configKey = 'papersignal-ai-config';

export default function App() {
  const [draft, setDraft] = useState<Draft>(newDraft);
  const [drafts, setDrafts] = useState<Draft[]>([]);
  const [brand, setBrand] = useState<Brand>({ name: 'PaperSignal', accent: '#FF6840', font: 'serif' });
